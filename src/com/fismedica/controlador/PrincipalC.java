...
public class PrincipalC {
	...
	public void initialize(){
		...
		lblUsuario.setText(Context.getInstance().getUsuario().getNombre() + " " + Context.getInstance().getUsuario().getApellido());
						...
						for(Menu menuHijo : menuList) {
							...
							btnMenuHijo.setOnMouseClicked(new EventHandler<Event>() {
								...
								public void handle(Event event) {
									helper.mostrarVentanaContenedor(menuHijo.getFxml(), ap_derecha);
								}
							});
