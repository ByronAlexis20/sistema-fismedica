...
import com.fismedica.main.LaunchFismedica;
...
public class ControllerHelper {
	...
	public void abrirPantallaModal(String uriVista, String titulo,Stage parent){
		try {
			...
			loader.setLocation(LaunchFismedica.class.getResource(uriVista));
	...
	public void mostrarVentanaContenedor(String uriVista,AnchorPane ap_contenedor){
		try{
			...
			FXMLLoader loader = new FXMLLoader(LaunchFismedica.class.getResource(uriVista));
